...
//------------下面的不用改
#define GPIO_IN        0x08 //输入寄存器偏地址
// #define GPIO_OUTD       0x0C //输出数据寄存器偏移地址
#define GPIO_SET       0x10 //BSHR 置位复位寄存器地址
#define GPIO_CLR       0x14 //BCR复位寄存器地址
